...
if ( ! function_exists( 'base_underscore_posted_on' ) ) :
	...
	function base_underscore_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'base-underscore' ),
...
if ( ! function_exists( 'base_underscore_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function base_underscore_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'base-underscore' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'base-underscore' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'base_underscore_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function base_underscore_post_thumbnail() {
